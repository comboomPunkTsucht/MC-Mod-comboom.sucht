package net.mcreator.comboompunktsucht.client.model;
...
public class Modelsteve<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("comboompunktsucht", "modelsteve"), "main");
