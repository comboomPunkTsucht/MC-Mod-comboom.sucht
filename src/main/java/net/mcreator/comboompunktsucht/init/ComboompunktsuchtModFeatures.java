...
import net.mcreator.comboompunktsucht.world.features.ores.CbpsgemoreFeature;
...
public class ComboompunktsuchtModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(CbpsgemoreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, CbpsgemoreFeature.GENERATE_BIOMES,
				CbpsgemoreFeature.CONFIGURED_FEATURE));
	}
